...
from system.views import home,admin_car_list, admin_msg, order_list, car_created, order_update, order_delete, msg_delete
from car_rental_app.views import (login_view, register_view, logout_view)
